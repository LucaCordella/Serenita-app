    ...
    <Card className="border-slate-700 bg-slate-900/50 shadow-lg">
      <CardHeader className="space-y-1 text-center">
        <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-teal-500/20">
          <span className="text-2xl font-bold text-teal-500">S</span>
        </div>
        <CardTitle className="text-2xl font-bold text-white">Serenità</CardTitle>
        <CardDescription className="text-slate-400">
          Seu companheiro diário para acompanhamento de saúde mental e autocuidado
        </CardDescription>
      </CardHeader>
      <CardContent>
